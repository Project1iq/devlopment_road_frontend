...
export default function Section1({ data }) {
  ...
  const countryOptions =
    [
      ...
      { value: "Botswana", label: "بوتسوانا (Botswana)" },
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://api.dashboard.elec-fair.com/form/", formData)
      .then((res) => {
  ...
  // Translation object for form labels
  const labels = {
    full_name: lang ? "الاسم الكامل" : "Full Name",
    email: lang ? "البريد الإلكتروني" : "Email Address",
    mobile_number: lang ? "رقم الجوال" : "Mobile Number",
    country: lang ? "البلد" : "Country",
    governorate: lang ? "المحافظة" : "Governorate",
    address: lang ? "العنوان" : "Address",
    gender: lang ? "الجنس" : "Gender",
    date_of_birth: lang ? "تاريخ الميلاد" : "Date of Birth",
    job_title: lang ? "المسمى الوظيفي" : "Job Title",
    specialization: lang ? "التخصص" : "Specialization",
    place_of_work: lang ? "مكان العمل" : "Place of Work",
    attendance_time: lang ? "وقت الحضور" : "Attendance Time",
    note: lang ? "ملاحظة" : "Note",
    submit: lang ? "إرسال" : "Submit",
  };
  ...
  return (
    <>
      <section className="section-1 mx-auto">
        <div className="bigcon container overflow-hidden d-flex justify-content-center">
          <div className="borda col-md-8 col-12">
            <div className="d-flex justify-content-center col-12">
              <div className="title mt-5"></div>
            </div>
            <div className="d-flex justify-content-center mt-4">
              <hr className="litline col-11" />
            </div>
  ...
  : "We’re excited to welcome you as a visitor to the Iraq International Energy Expo & Conference — a space where pioneers gather to shape the future with innovative and sustainable solutions."}
            ...
            <div className="form-container">
              <div className="container">
                <form className="card-form row justify-content-center" onSubmit={handleSubmit}>
                  <div className="input col-md-8 col-12">
                    <input
                      ...
                      required
                    />
                    <label className="input-label">{labels.full_name}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      type="email"
                  ...
                  <div className="input col-md-8 col-12">
                    <input
                      ...
                      required
                    />
                    <label className="input-label">{labels.mobile_number}</label>
                  </div>
                  <div className="input col-md-8 col-12" style={{ position: "relative" }}>
                    <Select
                    ...
                    />
                    <label className={`select-label ${isFocused || formData.country ? "focused" : ""}`}>
                      {labels.country}
                    </label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      ...
                      required
                    />
                    <label className="input-label">{labels.governorate}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      type="text"
                      ...
                      required
                    />
                    <label className="input-label">{labels.address}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <select
                      className="input-field"
                      ...
                      required
                    >
                      <option value="male">{lang ? "ذكر" : "Male"}</option>
                      <option value="female">{lang ? "أنثى" : "Female"}</option>
                    </select>
                    <label className="input-label">{labels.gender}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      type="date"
                  ...
                  <div className="input col-md-8 col-12">
                    <input
                      ...
                      required
                    />
                    <label className="input-label">{labels.job_title}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      type="text"
                      ...
                      required
                    />
                    <label className="input-label">{labels.specialization}</label>
                  </div>
                  <div className="input col-md-8 col-12">
                    <input
                      type="text"

...
export default function Section1({ data }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setFormData({ ...formData, country: res.data[0].name.common });
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  const countryOptions = [
    ...
    { value: "Antarctica", label: "أنتاركتيكا (Antarctica)" },
    {
      ...
      label: "أنتيغوا وباربودا (Antigua and Barbuda)",
    },
    ...
    { value: "Aruba", label: "أروبا (Aruba)" },
    {
      ...
      label: "منطقة آسيا/المحيط الهادئ (Asia/Pacific Region)",
    },
    ...
    { value: "Bolivia", label: "بوليفيا (Bolivia)" },
    {
      ...
      label: "بونير، سينت أوستاتيوس وسابا (Bonaire, Sint Eustatius and Saba)",
    },
    {
      value: "Bosnia and Herzegovina",
      label: "البوسنة والهرسك (Bosnia and Herzegovina)",
    },
    ...
    { value: "Brazil", label: "البرازيل (Brazil)" },
    {
      ...
      label: "إقليم المحيط الهندي البريطاني (British Indian Ocean Territory)",
    },
    {
      value: "Brunei Darussalam",
      label: "بروناي دار السلام (Brunei Darussalam)",
    },
    ...
    { value: "Cayman Islands", label: "جزر كايمان (Cayman Islands)" },
    {
      ...
      label: "جمهورية أفريقيا الوسطى (Central African Republic)",
    },
    ...
    { value: "Christmas Island", label: "جزيرة الكريسماس (Christmas Island)" },
    {
      ...
      label: "جزر كوكوس (كيلينغ) (Cocos (Keeling) Islands)",
    },
    ...
    { value: "Dominica", label: "دومينيكا (Dominica)" },
    {
      ...
      label: "جمهورية الدومينيكان (Dominican Republic)",
    },
    ...
    { value: "El Salvador", label: "السلفادور (El Salvador)" },
    {
      ...
      label: "غينيا الاستوائية (Equatorial Guinea)",
    },
    ...
    { value: "Ethiopia", label: "إثيوبيا (Ethiopia)" },
    {
      ...
      label: "جزر فوكلاند (Malvinas) (Falkland Islands (Malvinas))",
    },
    ...
    { value: "French Guiana", label: "غويانا الفرنسية (French Guiana)" },
    {
      ...
      label: "بولينيزيا الفرنسية (French Polynesia)",
    },
    {
      value: "French Southern Territories",
      label: "الأقاليم الجنوبية الفرنسية (French Southern Territories)",
    },
    ...
    { value: "Haiti", label: "هايتي (Haiti)" },
    {
      ...
      label: "جزيرة هيرد وجزر ماكدونالد (Heard Island and Mcdonald Islands)",
    },
    {
      value: "Holy See (Vatican City State)",
      label: "الكرسي الرسولي (دولة الفاتيكان) (Holy See (Vatican City State))",
    },
    ...
    { value: "Indonesia", label: "إندونيسيا (Indonesia)" },
    {
      ...
      label: "إيران (Iran, Islamic Republic Of)",
    },
    ...
    { value: "Kiribati", label: "كيريباتي (Kiribati)" },
    {
      ...
      label: "كوريا الجنوبية (Korea, Republic of)",
    },
    ...
    { value: "Liberia", label: "ليبيريا (Liberia)" },
    {
      ...
      label: "ليبيا (Libyan Arab Jamahiriya)",
    },
    ...
    { value: "Mexico", label: "المكسيك (Mexico)" },
    {
      ...
      label: "ولايات ميكرونيزيا المتحدة (Micronesia, Federated States of)",
    },
    ...
    { value: "Netherlands", label: "هولندا (Netherlands)" },
    {
      ...
      label: "جزر الأنتيل الهولندية (Netherlands Antilles)",
    },
    ...
    { value: "North Macedonia", label: "مقدونيا الشمالية (North Macedonia)" },
    {
      ...
      label: "جزر ماريانا الشمالية (Northern Mariana Islands)",
    },
    ...
    { value: "Palau", label: "بالاو (Palau)" },
    {
      ...
      label: "الأراضي الفلسطينية المحتلة (Palestinian Territory, Occupied)",
    },
    { value: "Panama", label: "بنما (Panama)" },
    {
      value: "Papua New Guinea",
      label: "بابوا غينيا الجديدة (Papua New Guinea)",
    },
    ...
    {
      value: "Cocos (Keeling) Islands",
      label: "جزر كوكوس (Cocos (Keeling) Islands)",
    },
    {
      value: "Congo, Democratic Republic",
      label: "جمهورية الكونغو الديمقراطية (Congo, Democratic Republic)",
    },
    {
      value: "Central African Republic",
      label: "جمهورية أفريقيا الوسطى (Central African Republic)",
    ...
    {
      value: "Falkland Islands (Malvinas)",
      label: "جزر فوكلاند (Falkland Islands (Malvinas))",
    },
    {
      value: "Micronesia, Federated States of",
      label: "ميكرونيزيا (Micronesia, Federated States of)",
    },
    { value: "Faroe Islands", label: "جزر فارو (Faroe Islands)" },
    { value: "France", label: "فرنسا (France)" },
    { value: "Gabon", label: "الغابون (Gabon)" },
    ...
    { value: "Greece", label: "اليونان (Greece)" },
    {
      ...
      label:
        "جورجيا الجنوبية وجزر ساندويتش الجنوبية (South Georgia and the South Sandwich Islands)",
    },
    { value: "Guatemala", label: "غواتيمالا (Guatemala)" },
    { value: "Guam", label: "غوام (Guam)" },
    { value: "Guinea-Bissau", label: "غينيا بيساو (Guinea-Bissau)" },
    ...
    { value: "Comoros", label: "جزر القمر (Comoros)" },
    {
      ...
      label: "سانت كيتس ونيفيس (Saint Kitts and Nevis)",
    },
    {
      value: "Korea (Democratic People's Republic of)",
      label: "كوريا الشمالية (Korea (Democratic People's Republic of))",
    },
    {
      value: "Korea, Republic of",
      label: "كوريا الجنوبية (Korea, Republic of)",
    ...
    { value: "Kazakhstan", label: "كازاخستان (Kazakhstan)" },
    {
      ...
      label: "لاوس (Lao People's Democratic Republic)",
    },
    { value: "Lebanon", label: "لبنان (Lebanon)" },
    ...
    { value: "Poland", label: "بولندا (Poland)" },
    {
      ...
      label: "سان بيير وميكلون (Saint Pierre and Miquelon)",
    },
    ...
    { value: "SG", label: "سنغافورة (Singapore)" },
    {
      value: "SH",
      label:
        "سانت هيلينا وأسينشين وتريستان دا كونا (Saint Helena, Ascension and Tristan da Cunha)",
    },
    ...
    { value: "UG", label: "أوغندا (Uganda)" },
    {
      value: "UM",
      label:
        "جزر الولايات المتحدة الصغيرة النائية (United States Minor Outlying Islands)",
    },
    {
      value: "US",
      label: "الولايات المتحدة الأمريكية (United States of America)",
    },
    ...
    {
      value: "VC",
      label: "سانت فنسنت والغرينادين (Saint Vincent and the Grenadines)",
    },
        ...
        <div action="" className="form-container">
          <div className="container pt-md-0 pt-5">
              ...
              <div className="allpic">
                <div className="title pt-5 d-flex align-content-center px-4 overflow-hidden mb-3 ">
                  ...
                  <h1 className=" px-2 textfade ">
                    {lang ? " احجز مساحتك" : "Reserve your space"}
                  </h1>
                </div>
            ...
            <form action="" onSubmit={handleSubmit} className="form row">
              ...
              <div className="col-md-6 col-12  ps-md-5 px-lg-2 px-0">
                <div className="input col-md-12 col-12 mt-md-0 mt-4 ">
                  <input
                    required
                    className="input-field"
                    type="email"
                ...
                <div className="input col-md-12 col-12">
                  ...
                  >
                    ...
                    <option value="other">{lang ? "أخرى" : "Other"}</option>
                  </select>
                  <label style={{ color: "#2f2f2f" }} className="input-label pb-2">

 ...
 const [isFocused, setIsFocused] = useState(false);
  ...
  >
    ...
    <option value="standerd">
      {lang ? "مساحة داخلية مع ديكور اعتيادي" : "Indoor Space with Standard Decoration"}
    </option>
    <option value="special">
      {lang ? "ديكور خاص" : "Special Decoration"}
    </option>
  </select>
  <label className="input-label">{lang ? "نوع الموقع" : "Location Type"}</label>
</div>
...
<div className="input col-md-12 col-12">
  ...
  <label className="input-label">{lang ? "ما مقدار المساحة" : "How much space"}</label>
</div>
